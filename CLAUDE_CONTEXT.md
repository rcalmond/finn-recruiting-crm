...
**`discovery_schools`** — cascades into 0 table(s); 4 blocker(s); 2 reference(s) silently nulled.
...
- BLOCKS `coaches.discovery_school_id` → `discovery_schools` [NO ACTION] — direct
...
| `coaches.discovery_school_id` | `discovery_schools` | NO ACTION |
